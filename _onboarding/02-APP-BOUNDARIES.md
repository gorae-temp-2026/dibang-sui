...
> **온체인 함의** ⚠️[변경 2026-06-21]: 이전엔 guest-web을 익명으로 두고 **claim/서비스 대리서명**으로 온체인
> 귀속하려 했으나 **폐기**. 이제 **guest-web에도 zkLogin 로그인+서명을 붙여, 게스트가 본인 지갑으로 방명록/축의/rsvp를
> 직접 온체인에 서명·기록한다.** claim·대리서명·"zkLogin UI 금지"는 모두 무효. (SSOT: `CLAUDE.md §2`)
